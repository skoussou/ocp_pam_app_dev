...
* *Business Central* Installation/Configuration:
	...
	$ ./Infrastructure/scripts73/setup_DEV_managed.sh <YOUR-DEV-NAMESPACE>pam-dev <YOUR-TOOLS-NAMESPACE>tools <CLUSTER PUBLIC URL>192.168.42.21
	...
	RHPAM Central Login: rhpamAdmin/rhpamAdmin730
