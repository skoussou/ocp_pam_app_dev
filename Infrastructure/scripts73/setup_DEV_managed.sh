...
oc create secret generic businesscentral-app-secret --from-file=./Infrastructure/templates73/secrets/bckeystore.jks -n ${DEV_NAMESPACE}
oc create secret generic kieserver-app-secret --from-file=./Infrastructure/templates73/secrets/kiekeystore.jks -n ${DEV_NAMESPACE}
...
sed -i "s@URL@${NEXUS_ROUTE_URL}/repository/maven-all-public/@" ./Infrastructure/templates73/settings.xml
