...
echo "#################################################################################################"
echo ""
oc new-app --template=rhpam76-prod-external-mariadb-managed  -p BUSINESS_CENTRAL_HTTPS_SECRET=businesscentral-app-secret -p KIE_SERVER_HTTPS_SECRET=kieserver-app-secret  \
...
-p KIE_SERVER_EXTERNALDB_SERVICE_PORT=3306 -p KIE_SERVER_EXTERNALDB_JNDI="java:/jboss/datasources/rhpam" -p KIE_SERVER_EXTERNALDB_DRIVER=mariadb \
